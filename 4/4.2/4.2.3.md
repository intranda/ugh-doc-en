...
<table>
  <thead>
    <tr>
      <th style="text-align:left"><code>&lt;IdentifierXPath&gt;</code>
      </th>
      <th style="text-align:left">
        <p>Selects the field in which the identifier of the person (in the example
          an ID from the person norm file PND) should be written. This function is
          still directly integrated in the UGH library. A use is currently only possible
  ...
  <tbody></tbody>
</table>_Example: Generation of persons_
...
### 4.2.3.4 Mapping for the MODS export - Corporations
...
## 4.2.3.5 Metadata mapping for import
